using OOPsReview.Data;  // this unit test MUST use and match the namespace
...
namespace ReviewUnitTests
{
    ...
    public class EmploymentTests
    {
        ...
        public void Employment_SetSupervisoryLevel_GoodSet(SupervisoryLevel level)
        {
                ...
                Assert.IsTrue(employment.Level==level, $"Employment level of {employment.Level} is incorrect, should be Owner.");
